...
st.markdown("<div class='main-title'> An BEST GAME FOR REVISION AND TEST</div>", unsafe_allow_html=True)
st.markdown('<a href="./" target="_blank" class="new-tab-btn">🚀 START GAME IN NEW TAB</a>', unsafe_allow_html=True)

# ================= 📚 સંપૂર્ણ NCERT ૧ થી ૧૨ નો અસલી માસ્ટર સિલેબસ ڈેટાબેઝ =================
    ...
    st.session_state.ncert_master_db = {
        "Std 10": {
            ...
            "ગણિત (Maths)": [
                ...
                "Ch 5: સમાંતર શ્રેણી", "Ch 6: ત્રિકોણ", "Ch 7: ยામ ભૂમિતિ", "Ch 8: ત્રિકોણમિતિનો પરિચય", "Ch 9: ત્રિકોણમિતિના ઉપયોગો", 
...
# ================= 🤖 ૧૦૦% સેફ ડાયનેમિક રેન્ડમ ક્વેશ્ચન મશીન =================
# 🚨 ફોર્મેટ ફિક્સ: હવે દરેક કન્ડિશન ફરજિયાત પ્રોપર 'ડિક્શનરી' ફોર્મમાં જ પ્રશ્ન મોકલશે
def get_dynamic_question(ch_name, sub_name, q_index):
    ...
    if "ગણિત" in sub_name or "Maths" in sub_name:
        ...
        ss_pool = [
            ...
            {"પ્રશ્ન": "ભારત દેશ આર્થિક દૃષ્ટિએ કેવો દેશ ગણાય છે?", "વિકલ્પો": ["વિકસિત", "Vિકાસશીલ", "પછાત"], "સાચો": "વિકાસશીલ"},
            {"પ્રશ્ન": "લોથલ સંસ્કૃતિનું પ્રખ્યાત બંદર કયા જિલ્લામાં આવેલું છે?", "વિકલ્પો": ["અમદાવાદ", "રાજકોટ", "ભાવનગર"], "સાચો": "અમદાવાદ"},
            {"પ્રશ્ન": "ભારતનો ભવ્ય સાંસ્કૃતિક વારસો શાના માટે જાણીતો છે?", "વિકલ્પો": ["વિવિધતા અને સમૃદ્ધિ", "માત્ર યુદ્ધો", "ગરીબી"], "સાચો": "વિવિધતા અને સમૃદ્ધિ"}
        ]
        ...
        # ગુજરાતી, અંગ્રેજી અને બાકી ભાષાઓ માટે ડિક્શનરી ફોર્મેટ ફિક્સ (જેથી ક્રેશ ન થાય)
        return {
            "પ્રશ્ન": "પાઠ્યપુસ્તકના ઊંડાણપૂર્વકના અભ્યાસ પ્રમાણે નીચેનામાંથી કયો વિકલ્પ ૧૦૦% સાચો છે?",
...
if st.session_state.game_finished:
    ...
    # 🚨 ટાઈપ ફિક્સ: હવે q એક ડિક્શનરી જ હોવાથી q['પ્રશ્ન'] ભૂલ વગર ૧૦૦% લોડ થશે
