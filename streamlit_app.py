...
# ================= 🔊 ૧૦૦% લાઉડ અને અનલોક ઓડિયો એન્જિન =================
def play_sound(sound_type):
    """વેબ ઓડિયો કોડ: આખા કમ્પ્યુટર કે ફોનના બ્રાઉઝર વોલ્યુમને બાયપાસ કરીને લાઉડ બીપ વગાડશે"""
    if sound_type == "correct":
        ...
        (function() {
            ...
            osc.type = 'sine';
            osc.frequency.setValueAtTime(587.33, ctx.currentTime); // D5 note - મધુર અને ઊંચો અવાજ
            gain.gain.setValueAtTime(0.2, ctx.currentTime); // ફૂલ લાઉડનેસ
            osc.connect(gain);
        ...
        (function() {
            ...
            var gain = ctx.createGain();
            osc.type = 'sawtooth';
            osc.frequency.setValueAtTime(130.81, ctx.currentTime); // C3 note - ઘેરો બઝર અવાજ
        ...
        (function() {
            ...
            var gain = ctx.createGain();
            osc.type = 'triangle';
            osc.frequency.setValueAtTime(440, ctx.currentTime); // A4 note - નાનો ક્લિક અવાજ
...
ss_chapters = [
    ...
    "પ્રકરણ ૧૫: આર્થિક વિકાસ", "પ્રકરણ ૧编制: આર્થિક ઉદારીકરણ અને વૈશ્વિકીકરણ", "પ્રકરણ ૧૭: આર્થિક સમસ્યાઓ અને પડકારો",
...
def get_dynamic_question(ch_name, sub_name, q_index):
    ...
    if "ગણિત" in sub_name:
        ...
        sci_pool = [
            ...
            {"પ્રશ્ન": "ભૂરા લિટમસ પત્રને લาล કોણ બનાવે છે?", "વિકલ્પો": ["એસિડ", "બેઇઝ", "ક્ષાર"], "સાચો": "એસિડ"},
