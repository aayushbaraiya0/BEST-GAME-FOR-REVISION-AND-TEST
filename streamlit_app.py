...
st.markdown("<div class='main-title'>幕 BEST GAME FOR REVISION AND TEST</div>", unsafe_allow_html=True)
...
if "ncert_master_db" not in st.session_state:
    st.session_state.ncert_master_db = {
        ...
        "Std 11": {
            ...
            "રસાયણ વિજ્ઞાન (Chemistry)": ["Ch 1: રસાયણ વિજ્ઞાનની પાયાની વિભાવનાઓ", "Ch 2: પરમાણુનું બંધારણ", "Ch 3: તત્વોનું વર્ગીકરણ"]
        },
        "Std 12": {
