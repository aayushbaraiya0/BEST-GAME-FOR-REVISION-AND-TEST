...
if "ncert_master_db" not in st.session_state:
    st.session_state.ncert_master_db = {
        ...
        "Std 6": {
            "વિજ્ઞાન (Science)": ["Ch 1: આહારના ઘટકો", "Ch 2: વસ્તુઓના જૂથ બનાવવા", "Ch 3: પદાર્થોનું અલગીકરણ", "Ch 4: વનસ્પતિની જાણકારી મેળવીએ", "Ch 5: शरीरનું હલનચલન", "Ch 6: સજીવો અને તેમની આસપાસ", "Ch 7: ગતિ અને અંતરનું માપન", "Ch 8: પ્રકાશ, પડછાયો અને પરાવર્તન", "Ch 9: વિદ્યુત તથા પરિપથ", "Ch 10: ચુંબક સાથે ગમ્મત"],
        ...
        "Std 11": {
            ...
            "রসાયણ વિજ્ઞાન (Chemistry)": ["Ch 1: রসાયણ વિજ્ઞાનની પાયાની વિભાવનાઓ", "Ch 2: પરમાણુનું બંધારણ", "Ch 3: તત્વોનું વર્ગીકરણ"]
        },
        "Std 12": {
            ...
            "रसાયણ વિજ્ઞાન (Chemistry)": ["Ch 1: દ્રાવણો", "Ch 2: વિદ્યુતરસાયણ", "Ch 3: રાસાયણિક ગતિકી", "Ch 4: d- અને f- વિભાગના તત્વો"]
        }
    }
...
# 🚨 એરર ફિક્સ લોજિક: હાથેથી ઇન્ડેક્સ નંબર લખવાના બદલે ડાયનેમિક ઇન્ડેક્સ શોધવાનું સેટિંગ કર્યું
